...
- `legacy_nextjs_backup/` is an unrelated archived import scaffold (old Next.js/Vercel misdetection artifacts) — irrelevant to this app; do not source features from it.
