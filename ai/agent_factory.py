...
AGENT_CATALOGUE: Dict[str, dict] = {
    ...
    "CodingAgent": {
        ...
        "capabilities": ["plan", "write_code", "run_file", "run_tests", "debug", "web_search", "deep_research", "self_learn", "git_push", "git_lfs", "search_code", "git_info", "py_compile", "fetch_url", "trending"],
