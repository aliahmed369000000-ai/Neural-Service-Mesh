"""
Byte-level BPE (BBPE) — أسلوب GPT-2 / محايد اللغات.
...
لماذا يعمل على «أي لغة»؟
  - لا يعتمد على مسافات أو جذور أو قواميس كلمات
  - العربية والصينية واليابانية والروسية والإنجليزية كلها بايتات UTF-8
  - يكفي تدريب القاموس على مزيج نصوص من اللغات المستهدفة

تدريب متعدد اللغات:
  python3 scripts/train_byte_bpe_multilingual.py --demo
"""
