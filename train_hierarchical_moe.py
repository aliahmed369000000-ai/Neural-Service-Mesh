...
SEED_SENTENCES: Dict[str, List[str]] = {
    ...
    "math": [
        ...
        "مقدمة في التفاضل والمشتقات",
        "الإحصاء والمتوسط الحسابي",
    ],
    "medicine": [
    ...
    "history": [
        "أحداث في التاريخ الإسلامي",
        "أسباب الحرب العالمية الثانية",
    ],
    "media": [
        "كتابة محتوى للمنصات الاجتماعية",
        "إنتاج فيديو قصير",
    ],
    "psychology": [
    ...
    "arabic": [
        ...
        "أساليب البلاغة والتشبيه",
    ],
    "usul": [
        "تعريف أصول الفقه ومصادره",
    ...
    "tajweed": [
        ...
        "طرق حفظ القرآن للمبتدئين",
    ],
    "islamic_finance": [
        "صيغة المرابحة في البنوك الإسلامية",
        "حساب الزكاة على المال",
        "مفهوم الصكوك الإسلامية",
    ],
    "literature": [
        "تحليل قصيدة عربية كلاسيكية",
        "عناصر الرواية الحديثة",
        "نقد أدبي للنثر",
    ],
    "astronomy": [
        "مكونات المجموعة الشمسية",
        "رصد النجوم بالتلسكوب",
    ],
    "geography": [
        "التضاريس والمناخ",
        "قراءة الخرائط الجغرافية",
    ],
    "engineering": [
        "أساسيات الهندسة المدنية",
        "الدوائر الكهربائية البسيطة",
        "مبادئ الميكانيكا الهندسية",
    ],
    "family": [
        "تربية الأطفال في المرحلة المبكرة",
        "مهارات التواصل في الزواج",
        "توجيه الشباب",
    ],
    "cooking": [
        "وصفة طبخ عربية تقليدية",
        "وجبات صحية سريعة",
    ],
    "travel": [
        "التخطيط لرحلة سياحية",
        "نصائح لعمرة ميسّرة",
    ],
    "environment": [
        "تغير المناخ وآثاره",
    ...
    "agriculture": [
        "زراعة المحاصيل الموسمية",
        "تربية الماشية الحديثة",
    ],
    "economy": [
